...
namespace FortuneVoronoyTest
{
    ...
    public class UnitTest1
    {
        ...
        public void GeneralTest2()
        {
            ...
            p1.Vertices = new List<PointD>() { new PointD(727.6555672545406, -116.99039220847601), new PointD(987.1936383928571, 298.98158482142856), };
            Polygon p2 = new Polygon(new PointD(1119, 235));
            p2.Vertices = new List<PointD>() { new PointD(987.1936383928571, 298.98158482142856), new PointD(1045.422925797189, 467.5400483602842), new PointD(2123.7180612244897, -92.75056122448984), };
            ...
            p8.Vertices = new List<PointD>() { new PointD(2123.7180612244897, -92.75056122448984), new PointD(1190.3575763403635, 994.0819496976303), };
